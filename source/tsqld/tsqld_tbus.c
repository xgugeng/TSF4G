...
static void tsqld_tbus_on_tsqld_query(const tsqld_query_s *requery)
{
}
...
static void tsqld_tbus_pkg(const tsqld_protocol_t *req)
{
    ...
    {
    case e_tsqld_query:
        tsqld_tbus_on_tsqld_query(&req->body.query);
        break;
    }
}
